...
public class insercao {
    ...
    public static void insercao(ListaSeq lista){

        for(int i = 0; i < lista.getSize(); i++){
            int menor = i;
            for(int j = i+1; j < lista.getSize(); j++){
                if(lista.array[menor].getReleaseDate().compareTo(lista.array[j].getReleaseDate()) > 0){
                    menor = j;
                }else if(lista.array[menor].getReleaseDate().compareTo(lista.array[j].getReleaseDate()) == 0){
                    if(lista.array[menor].getReleaseDate().compareTo(lista.array[j].getReleaseDate()) > 0)
                        menor = j;
                }
            }
