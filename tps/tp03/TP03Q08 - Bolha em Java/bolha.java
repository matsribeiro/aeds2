...
public class bolha {
    ...
    public static void bolha(ListaSeq lista){

        for(int i = 0; i < lista.getSize(); i++){
            int menor = i;
            for(int j = i+1; j < lista.getSize(); j++){
                if(lista.array[menor].getDuration() > lista.array[j].getDuration()){
                    menor = j;
                }else if(lista.array[menor].getDuration() == lista.array[j].getDuration()){
                    if(lista.array[menor].getDuration() < lista.array[j].getDuration())
                        menor = j;
                }
            }
